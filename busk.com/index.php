...
<div class="container-fluid">
	<div >
		...
		<h4>E mais de <?php echo $total_usuarios; ?> usuários cadastrados.</h4>
	</div>
	...
	<div class="row">
		<div class="col-sm-3">
			<h3 class="light"> Pesquisa Avançada</h3>
			<form method="GET">
				<div class="form-group">
					<label for="categoria" class="navbar-brand ">Categoria:</label>
				...
				<div class="form-group">
					<label for="preco" class="navbar-brand ">Preço:</label>
				...
				<div class="form-group">
					<label for="estado" class="navbar-brand ">Estado de Conservação:</label>
					<select id="estado" name="filtros[estado]" class="form-control 12px " >
						<option></option>
			...
			<div class="col s12 m7 black">
				<h2 class="header">Anuncios</h2>
			<div class="card horizontal">

			<div class="card-stacked">
				<div class="card-content">
					<p>Anuncie aqui sua marca</p>
			</div>
		...
		<div class="col-sm-9">
			<h3 class="light">Últimos Anúncios</h3>
				...
				<tbody>
					...
					<tr>
						<td>
							...
							<img src="assets/images/anuncios/<?php echo $anuncio['url']; ?>" height="60" border="0" />
							<?php else: ?>
							<img src="assets/images/default.jpg" height="50" border="0" />
							<?php endif; ?>
						</td>
						<td>
							<a href="produto.php?id=<?php echo $anuncio['id']; ?>"><h4><?php echo $anuncio['titulo']; ?></h4></a><br/>
